...
xst -ifn xst.scr
move pacman_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pacman_clock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pacman_clock_exdes.ucf pacman_clock_exdes

echo 'Running map'
map -timing -pr b pacman_clock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pacman_clock_exdes -w routed.ncd routed.v
cd ..
