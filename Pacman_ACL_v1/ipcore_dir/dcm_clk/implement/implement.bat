...
copy ..\example_design\dcm_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_clk_exdes.ucf dcm_clk_exdes
...
netgen -ofmt verilog -sim -sdf_anno false -tm dcm_clk_exdes -w routed.ncd routed.v
cd ..
