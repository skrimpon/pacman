...
xst -ifn xst.scr
move PacMan_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PacMan_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PacMan_clk_exdes.ucf PacMan_clk_exdes

echo 'Running map'
map -timing -pr b PacMan_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm PacMan_clk_exdes -w routed.ncd routed.v
cd ..
